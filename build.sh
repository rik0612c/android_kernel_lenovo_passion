...
# Dirs
KERNEL_DIR=~/Sources/rr_pie/kernel/lenovo/passion
ANYKERNEL_DIR=$KERNEL_DIR/AnyKernel2
KERNEL_IMG=$KERNEL_DIR/arch/arm64/boot/Image
DT_IMAGE=$KERNEL_DIR/arch/arm64/boot/dt.img
UPLOAD_DIR=~/Sources/upload/$DEVICE
DTBTOOL=$KERNEL_DIR/tools/dtbToolCM

# Export
export ARCH=arm64
export CROSS_COMPILE=~/Sources/Utility/aarch64-linux-android-4.9/bin/aarch64-linux-android-
